...
pomExtra :=
  <url>https://github.com/jyuhuan/gringotts</url>
    <licenses>
      <license>
        <name>MIT</name>
    ...
    <scm>
      <url>git@github.com:jyuhuan/gringotts.git</url>
      <connection>scm:git:git@github.com:jyuhuan/gringotts.git</connection>
    </scm>
    <developers>
      <developer>
        <id>yuhuan</id>
